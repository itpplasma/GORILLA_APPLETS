...
% description:
%-----------------------------------------------------------------------------------------------------------------------
% Calculate one orbit with Gorilla for a trapped Deuterium particle with a field-aligned grid for non-axisymmetric VMEC
% Compare the results for different polynominal orders in the calculation of Gorilla
% Create a figure with the Poincare section and parallel adiabatic invariant
%
%#######################################################################################################################
% programed functions:
%-----------------------------------------------------------------------------------------------------------------------
...
%Poincare Plot trapped particles in VMEC
figure
subplot(1,3,1)
...
xlabel('R [cm]')
ylabel('z [cm]')
title('Poincar\.{e} section ($v_{par}=0$) Stellerator','Interpreter','latex');
hold off
