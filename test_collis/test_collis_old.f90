!to compile, write "gfortran test_collis_old.f90 -fopenmp -o old_test"
program test_collis
  use collis_alp
...
k = 0
  ...
  energy_of_t=energy_of_t/dble(num_particles)
    open(1, file='energy_average_old.dat')
  do i = 1, num_t_step
      write (1,*) dble(i-1)*dtau/v0, energy_of_t(i)
  enddo
    close(1)
    print*, 'End of test of old version of collision operator'
